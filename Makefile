...
SRCS=Main.cpp FileSystem.cpp TextureManager.cpp Window.cpp Engine.cpp Camera.cpp Shader.cpp Quad.cpp ModelTechnique.cpp SkinnedModelTechnique.cpp SkinnedModel.cpp Model.cpp AnimNode.cpp Mesh.cpp 
