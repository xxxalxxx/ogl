...
public:
    ...
    Model(string const & path, Shader shader, int aiProcessArgs = 0, bool gamma = false) : gammaCorrection(gamma)
    {
...
private:
    ...
    void loadModel(string path, int aiProcessArgs, Shader shader)
    {
